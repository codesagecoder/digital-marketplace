    ...
    return (
      <Link
        ...
        <div className="flex flex-col w-full">
          ...
          <p className="mt-1 text-sm to-gray-500">{label}</p>
          <p className="mt-1 font-medium text-sm to-gray-900">{formatPrice(product.price)}</p>
        </div>
      </Link>
    )
  }
...
const ProductPlaceholder = () => {
  return (
    <div className="flex flex-col w-full">
      ...
      <Skeleton className="mt-2 w-16 h-6 rounded-lg" />
