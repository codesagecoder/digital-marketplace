...
const VerfiyEmail = ({ token }: VerfiyEmailProps) => {
        ...
        return (
            <div className="flex h-full flex-col items-center justify-center">
                <div className="relative mb-4  h-60 w-60 text-muted-foreground">
                    <Image src='/hippo-email-sent.png' fill alt="the eamil was sent" />
                </div>
                <h3 className="font-semibold text-2xl">You&apos;re all set!</h3>
                <p className="to-muted-foreground text-center mt-1">Thank you for verifying your email.</p>
