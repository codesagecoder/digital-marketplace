      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:max-w-lg lg:self-end">
            ...
            <div className="mt-4">
              <h1 className="text-3xl font-bold tracking-light text-gray-900 sm:text-4xl">{product.name}</h1>
            </div>
            <section className="mt-4">
              <div className="flex items-center">
                <p className="font-medium text-gray-900">{formatPrice(product.price)}</p>
                <div className="ml-4 border-l to-muted-foreground border-gray-300 pl-4">{label}</div>
              </div>
          ...
          <div className="mt-10 lg:col-span-2 lg:row-start-2 lg:mt-0 lg:self-center">
